...
def merge_wsi_feat(wsi_feat_dir) -> None:
    ...
    merge_feat_save_dir = r'path\to\result\wsi_x5loss'
...
if __name__ == '__main__':
    ...
    # tile级别存储路径
    feat_save_dir_X5 = cfg['savedir_5']
    # wsi 级别保存路径
    merge_feat_save_dir_X5 = cfg['savedir_com5']
    for feat_save_dir, merge_feat_save_dir in zip([feat_save_dir_X5],[merge_feat_save_dir_X5]):
