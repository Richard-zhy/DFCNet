...
class ResNetSimCLR(nn.Module):
    ...
    def __init__(self, base_model, out_dim):
        ...
        self.resnet_dict = {"resnet18": models.resnet18(pretrained=False, norm_layer=nn.InstanceNorm2d),
                            ...
                            "effv2_s": models.efficientnet_v2_s(pretrained=False),
                            "effb0":models.efficientnet_b0(pretrained=False)}

        resnet = self._get_basemodel(base_model)
        num_ftrs = resnet.classifier[1].in_features
        self.features = nn.Sequential(*list(resnet.children())[:-1])[0]
    ...
    def forward(self, x):
        ...
        h = nn.functional.adaptive_avg_pool2d(h, output_size=(1))
