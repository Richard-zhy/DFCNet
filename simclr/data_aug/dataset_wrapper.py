...
from .gaussin_blur import GaussianBlur
...
class DataSetWrapper(object):
    ...
    def get_data_loaders(self):
        ...
        # train_dataset = Dataset(csv_file='X5_all_patches.csv', transform=SimCLRDataTransform(data_augment))
        train_dataset = Dataset(csv_file='X20_all_patches.csv', transform=SimCLRDataTransform(data_augment))
