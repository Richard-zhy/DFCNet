...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='X20', help='Dataset folder name')
    args = parser.parse_args()
    config = yaml.load(open(r"path\to\configs\X5_config.yaml", "r"), Loader=yaml.FullLoader)
